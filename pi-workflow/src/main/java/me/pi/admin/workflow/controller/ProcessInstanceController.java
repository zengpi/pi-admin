...
public class ProcessInstanceController {
    ...
    @Operation(summary = "启动新的流程实例")
    @PostMapping
    public ResponseData<StartProcessInstanceVO> startNewProcessInstance(@RequestBody @Valid StartProcessInstanceDTO dto) {
        return ResponseData.ok(flowableProcessInstanceService.startProcessInstance(dto));
    }
    ...
    public ResponseData<IPage<MyProcessInstanceVO>> listMyProcesses(MyProcessQuery myProcessQuery) {
        return ResponseData.ok(flowableProcessInstanceService.getMyProcesses(myProcessQuery));
    }

    @DeleteMapping("/delete/{processInstanceId}")
    @Operation(summary = "删除流程实例")
    public ResponseData<?> delete(@PathVariable String processInstanceId) {
        flowableProcessInstanceService.delete(processInstanceId);
    ...
    public ResponseData<?> cancel(@PathVariable String processInstanceId) {
        flowableProcessInstanceService.cancel(processInstanceId);
        return ResponseData.ok();
    }
    ...
    public ResponseData<ProcessInstanceDetailVO> getProcessInstanceDetail(@PathVariable String processInstanceId) {
        return ResponseData.ok(flowableProcessInstanceService.getProcessInstanceDetail(processInstanceId));
    }
}
