...
import me.pi.admin.workflow.service.FlowableProcessDeploymentService;
...
public class ProcessDeploymentController {
    private final FlowableProcessDeploymentService flowableProcessDeploymentService;
    ...
    public ResponseData<IPage<ProcessDeploymentVO>> listDeployments(BaseQuery baseQuery) {
        return ResponseData.ok(flowableProcessDeploymentService.listDeployments(baseQuery));
    }
    ...
    public ResponseData<?> deleteDeployments(@PathVariable Set<String> ids) {
        flowableProcessDeploymentService.deleteDeployments(ids);
