...
public interface FlowableProcessInstanceService {
     ...
     * @return 启动流程实例的结果
     */
    StartProcessInstanceVO startProcessInstance(StartProcessInstanceDTO dto);

    /**
     * 根据流程实例 id 获取流程启动表单信息
     *
     * @param processInstanceId 流程实例 id
     * @return 流程启动表单信息
     */
    FormInfo getProcessInstanceStartForm(String processInstanceId);
