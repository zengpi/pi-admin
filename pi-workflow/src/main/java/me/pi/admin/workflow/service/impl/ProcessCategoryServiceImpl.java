...
public class ProcessCategoryServiceImpl extends ServiceImpl<ProcessClassMapper, ActReCategory> implements ProcessCategoryService {
    ...
    public void deleteCategories(Collection<Long> ids) {
        ...
        Boolean isExists = processModelService.isExistsByCategories(categories);
        if(isExists) {
