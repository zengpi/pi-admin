...
public class ProcessCategoryController {
    private final FlowableProcessCategoryService flowableProcessCategoryService;
    ...
    public ResponseData<IPage<ProcessCategoryVO>> listCategories(BaseQuery baseQuery) {
        return ResponseData.ok(flowableProcessCategoryService.listCategories(baseQuery));
    }
    ...
    public ResponseData<?> saveCategory(
        ...
        flowableProcessCategoryService.saveOrUpdate(processCategoryDto);
    ...
    public ResponseData<?> deleteCategories(@PathVariable Set<Long> ids) {
        flowableProcessCategoryService.deleteCategories(ids);
        return ResponseData.ok();
    }
}
